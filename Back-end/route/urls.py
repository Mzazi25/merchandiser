...
from route.views import CustomAuthToken, ManagerOnlyView, ManagerSignupView, MerchandiserOnlyView,MerchandiserSignupView,LogoutView,LoginMerch

app_name = 'route'
urlpatterns = [
    path('signup/manager/',ManagerSignupView.as_view()),
    path('signup/merchandiser/',MerchandiserSignupView.as_view()),
    path('api/auth/login',LoginMerch.as_view()),
